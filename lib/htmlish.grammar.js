(function() {
  'use strict';
  var CND, GRAMMAR, Htmlish_grammar, MAIN, alert, assign, badge, dd, debug, echo, freeze, grammar, help, info, isa, jr, lets, log, new_grammar, rpr, type_of, types, urge, validate, warn, whisper;
