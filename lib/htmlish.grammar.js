(function() {
  'use strict';
  var $parse, CND, GRAMMAR, Htmlish_grammar, MAIN, PGTH, alert, assign, badge, dd, debug, echo, freeze, grammar, help, info, isa, jr, lets, log, merge_texts, new_datom, new_grammar, parse, rpr, strip_quotes, type_of, types, urge, validate, warn, whisper;
      ...
      case 'osntag':
        ...
        if ((attributes = tree.ukids.attributes) != null) {
          ...
          for (j = 0, len1 = ref3.length; j < len1; j++) {
            ...
            v = strip_quotes((ref4 = (ref5 = attribute.ukids.v_value) != null ? ref5.text : void 0) != null ? ref4 : true);
            atrs[k] = v;
          }
          d = {
            $key,
