(function() {
  'use strict';
  var $parse, CND, GRAMMAR, Htmlish_grammar, MAIN, PGTH, alert, assign, badge, dd, debug, echo, freeze, grammar, help, info, isa, jr, lets, log, new_datom, new_grammar, rpr, type_of, types, urge, validate, warn, whisper;
