(function() {
  'use strict';
  var CND, GRAMMAR, MAIN, Multimix, Rxws_grammar, alert, assign, badge, debug, echo, freeze, help, info, isa, jr, lets, log, rpr, rxws_grammar, space_re, type_of, types, urge, validate, warn, whisper;
