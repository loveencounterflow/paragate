...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('paragate_parsers_lexer_token_matcher', {
    tests: {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('paragate_parsers_lexer_token_description', {
    tests: {
      "x is an object": function(x) {
        return this.isa.object(x);
      },
      "x.match is a valid token matcher": function(x) {
        return this.isa.paragate_parsers_lexer_token_matcher(x.match);
      },
